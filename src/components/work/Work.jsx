      ...
      <Layout>
        <section id='ryde' className="ryde reveal-work work-section">
          <div className="title">
            ...
            <button className='btn-work' style={{fontFamily:  'Gotham-light, sans-serif', backgroundColor: 'rgb(50, 54, 56)', letterSpacing: '0.3em', padding: '15px 29px', fontSize: '11px', border: '0', marginTop: '15px', color: 'white'}}>VIEW PROJECT</button>
          </div>
        </section>
