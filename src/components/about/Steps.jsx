  ...
  return (
    <div>
        <div className='row' style={{marginBottom: '15vw'}}>
            <div className='next-steps col-lg-4 reveal-about' style={{marginBottom: '2vw'}}>
                ...
                <button className='btn-talk reveal-about' style={{fontFamily: 'Gotham-light, sans-serif', backgroundColor: 'rgb(50, 54, 56)', letterSpacing: '0.3em', padding: '15px 29px', fontSize: '11px', border: '0', marginTop: '15px', color: 'white', maxHeight: '45px'}}>LET'S TALK</button>
            </div>
        ...
        <div className='row' style={{marginBottom: '5vw'}}>
            ...
            <div className='loc-text col-lg-4 reveal-about' >
