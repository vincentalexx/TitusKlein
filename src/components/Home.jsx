  ...
  return (
    <div className='home' style={{width: '100vw', height: '100vh', }}>
      ...
      <nav ref={navRef} className='menu d-flex flex-column '>
        ...
        <a href="" className='toggle text-decoration-none text-white' style={{ fontWeight: '700', letterSpacing: '0.3vw', paddingTop: '12px', paddingBottom: '12px', width: '150px'}}>ABOUT</a>
        ...
        <a href="" className='startproject text-decoration-none text-white' style={{fontWeight: '700', letterSpacing: '0.3vw', paddingTop: '12px', paddingBottom: '12px', width: '320px', marginTop: '40px'}}>Start A Project
