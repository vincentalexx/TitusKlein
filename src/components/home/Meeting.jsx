  ...
  return (
    <section id='meeting' className='' style={{marginBottom: '70px'}}>
        ...
        <div style={{marginLeft: '3vw', marginRight: '3vw', marginBottom: '3vw'}}>
            <p className='reveal meet-text' style={{fontFamily: 'Gotham-medium, sans-serif', fontSize: '20px', letterSpacing: '0.1em', marginBottom: '30px'}}>VIEW OUR WORK</p>
            <div className='work'>
                <a href="#" className='reveal work-card text-decoration-none'>
